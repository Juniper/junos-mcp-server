...
def main(steady_path, reboot_path, fpcs=None):
    ...
    if fpcs is not None:
        ...
        output_file = "merged_all_isis_comparison.xlsx"
    else:
        output_file = "merged_all_isis_comparison.xlsx"
    ...
    group_cols_nonnum = ['path', 'interface_id', 'field', 'value', 'component', 'component_id', 'level_number', 'safi_name', 'afi_name']
    ...
    group_cols_num = ['path', 'interface_id', 'field', 'component', 'component_id', 'level_number', 'safi_name', 'afi_name', 'value']
    ...
    group_cols_ordered = ['path', 'interface_id', 'field', 'value', 'component', 'component_id', 'level_number', 'safi_name', 'afi_name']
